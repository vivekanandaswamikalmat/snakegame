...
void WelcomeScreen() {
    ...
    glRasterPos2f(-40, -10);
    Write((char*)"=========SIMULATION OF SNAKE GAME=========");
    glRasterPos2f(-20, 5);
    Write((char*)"=========CG MINI PROJECT=========");
    glRasterPos2f(0, -40);
    Write((char*)"To Start Playing please press 'S'");
    glRasterPos2f(80, -90);
    Write((char*)"by:");
    glRasterPos2f(80, -100);
    Write((char*)"1MV19CS068 MD SHAHID");
    glRasterPos2f(80, -110);
    Write((char*)"1MV19CS126 VIVEKANANDA K");
    glRasterPos2f(80, -120);
    Write((char*)"1MV19CS129 YASHWANTH L NALLA");
...
void GameStatus() {
    ...
    Write(tmp_str);
    glRasterPos2f(90, 10);
    sprintf_s(tmp_str, "Timer %f", duration/1000);
    Write(tmp_str);
    if (lvl != 1 && points%5==0) {
        glRasterPos2f(5, 0);
        sprintf_s(tmp_str, "Level %d completed in %d Seconds", lvl - 1, (int)(duration/1000));
        Write(tmp_str);
    }
}
